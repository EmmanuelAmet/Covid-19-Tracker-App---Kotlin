...
class Adapter: RecyclerView.Adapter<Adapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.recovered_item.text = "Recovered: ${myList[position].recovered}"
//        holder.itemView.death_item.text = myList[position].deaths
        holder.itemView.active_cases_item.text = "Active: ${myList[position].active}"
...
class AdapterCountry: RecyclerView.Adapter<AdapterCountry.MyViewHolder>() {
    var myList = emptyList<Case>()
    fun setData(){
        val newList: List<Case>
        //myList = newList
        notifyDataSetChanged()
    }
    inner class MyViewHolder(itemView: View): RecyclerView.ViewHolder(itemView)
